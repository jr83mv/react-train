function Cards(props:any){
    return (
<div className={`h-[310px] w-[600px] p-[50px] ${props.data.bgColor} rounded-[45px] shadow border border-zinc-900 justify-between items-center gap-[77px] flex`}>
    ...
    <div className=" w-[230px] h-[170px] pt-0.5 pb-[1.95px] justify-center items-center flex">
