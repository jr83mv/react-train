    ...
    return (<div>
        <div className=" px-[100px] justify-between items-start gap-[106px] inline-flex">
                <div className="justify-between items-center gap-[35px] flex-col " id="inner-container">
                    ...
                    <div className=" flex items-center gap-2.5 sm:gap-2 py-5 px-9 mt-[35px] rounded-2xl bg-black" id="booking-bt">
            ...
            <div className="flex px-[100px] justify-between items-start gap-[100px] inline-flex">
                {logos.map((logo:any) =>(
                        <img src={logo.url} alt={logo.name}  className=" h-12 relative"/>)
                    )}
            </div></div>
    )
}
