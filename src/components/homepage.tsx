    ...
    return(
        <div className=" flex-col justify-start items-start gap-[70px] inline-flex" id="outer-container">
            ...
            <div className="px-[100px] justify-start items-start gap-10 inline-flex">
                ...
                <div className="wtext-black text-[18px] font-normal text-start">Explore Real-Life Examples of Our Proven Digital Marketing Success through Our Case Studies</div>
            </div>
            ...
            <div className="px-[100px] flex-col justify-start items-start gap-[30px] inline-flex" style={{width: '100%'}}>
            ...
            <div className="w-[269px] h-[68px] px-[35px] py-5 bg-zinc-900 rounded-2xl justify-center self-end items-center gap-2.5 inline-flex mr-24">
                <button className="text-center text-white text-[20px] font-normal leading-7">See all team</button>
            </div>
            ...
            <div className=" px-[100px] justify-start items-start gap-10 inline-flex">
                ...
                <div className=" text-black text-[18px] font-normal text-start">Connect with Us: Let's Discuss Your Digital Marketing Needs</div>
            </div>
            </div>
                ...
                <div className="justify-start items-start gap-[45px] inline-flex">
                    <div className="justify-start items-start gap-[15px] inline-flex">
                        <div className="w-7 h-7 relative">
                            <div className="w-7 h-7 left-0 top-0 absolute bg-white rounded-[29px] border border-black" />
                    ...
                    <div className=" flex-col justify-start items-start gap-[5px] flex">
                        ...
                        <input type="text" className=" h-[190px] px-[30px] py-[18px] bg-white rounded-2xl border border-black justify-start items-start gap-2.5" placeholder="Message"/>
                    </div>
                    </div>
                    <div className=" px-[35px] py-5 bg-zinc-900 rounded-2xl justify-center items-center gap-2.5 inline-flex">
                    <button className="text-center text-white text-[20px] font-normal leading-7">Send Message</button>
                    </div>
                </div>
            </div>

            <div className=" px-[60px] pt-[55px] ml-24 pb-[50px] bg-zinc-900 rounded-tl-[45px] rounded-tr-[45px] flex-col justify-start items-start gap-[50px] inline-flex">
                <div className="flex-col justify-start items-start gap-[66px] flex">
                    ...
                    <div className="px-10 py-[58px] bg-zinc-800 rounded-2xl justify-start items-start gap-5 flex">
                        <input type="text" className="text-white w-[200px] text-[18px] font-normal text-start bg-zinc-800 h-[67px] px-[35px] py-[22px] rounded-2xl border border-white justify-start items-start gap-2.5 flex" placeholder="Email"/>
                        <div className="px-[35px] py-5  bg-lime-300 rounded-2xl justify-start items-start gap-2.5 flex">
                        <button className="text-center text-black w-[200px] text-[20px] font-normal leading-7">Subscribe to news</button>
                        </div>
                    </div>
                    </div>
                </div>
